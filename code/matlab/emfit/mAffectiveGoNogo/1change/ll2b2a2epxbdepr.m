function [l,dl,dsurr] = ll2b2a2epxbdepr(x,D,mu,nui,doprior,options);
% 
...
for t=1:length(a)
	...
	q = Q(:,s(t));
    pav = exp(epsilon(2-rho) + rho * sess(t) * delta);
	...
	if dodiff
        ...
        dl(9) = dl(9) + g*(p0(a(t)) * rho * sess(t) * pav * V(s(t)) * ((a(t)==1)-p0(1))) / pg(a(t));
