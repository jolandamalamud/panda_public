function [track,l,dl,dsurr] = llba4epxb(x,D,mu,nui,doprior,options);
% 
...
epsilon 	= exp(x(3:6));				% 'pavlovian' parameter. Weigth of Vcue into Qgo
...
for t=1:length(a)
	...
	if dodiff
		...
		dl(s(t)+2) = dl(s(t)+2) + g*(p0(a(t))*epsilon(s(t))*V(s(t)) * ((a(t)==1)-p0(1))) / pg(a(t));
