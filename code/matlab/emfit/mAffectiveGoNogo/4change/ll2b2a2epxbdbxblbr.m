function [l,dl,dsurr] = ll2b2a2epxbdbxblbr(x,D,mu,nui,doprior,options);
% 
...
for t=1:length(a)
    ...
    psi = exp(beta(2-rho) + sess(t) * deltabl(2-rho));
	er = psi * r(t);
	...
	if dodiff
        ...
        dl(12-rho) = dl(12-rho) + noise*(p0(a(t)) * (tmp(a(t)) - p0'*tmp)) / pg(a(t));
        dQdd(a(t),s(t)) = (1-alfa(2-rho))*dQdd(a(t),s(t)) + alfa(2-rho) * sess(t) * psi * r(t);
		dVdd(     s(t)) = (1-alfa(2-rho))*dVdd(     s(t)) + alfa(2-rho) * sess(t) * psi * r(t);
