function [l,dl,dsurr] = ll2b2a2epxbdbxblepl(x,D,mu,nui,doprior,options);
% 
...
for t=1:length(a)
    ...
    pav = exp(epsilon(2-rho) + (1-rho) * sess(t) * deltaepl);
	...
	if dodiff
        ...
        tmp = (dQdd(:,s(t)) + [pav*dVdd(s(t));0]);
        dl(11) = dl(11) + noise*(p0(a(t)) * (tmp(a(t)) - p0'*tmp)) / pg(a(t));
        dQdd(a(t),s(t)) = (1-alfa(2-rho))*dQdd(a(t),s(t)) + alfa(2-rho) * (1-rho) * sess(t) * er;
		dVdd(     s(t)) = (1-alfa(2-rho))*dVdd(     s(t)) + alfa(2-rho) * (1-rho) * sess(t) * er;
        ...
        dl(12) = dl(12) + noise*(p0(a(t)) * (1-rho) * sess(t) * pav * V(s(t)) * ((a(t)==1)-p0(1))) / pg(a(t));
