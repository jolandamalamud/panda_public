function [l,dl,dsurr] = ll2b2a2epxbdbxblar(x,D,mu,nui,doprior,options);
% 
...
for t=1:length(a)
    ...
    lr = 1./(1+exp(-alfa(2-rho) - rho * sess(t) * deltaar));
	...
	if dodiff
		...
		dQdde(a(t),s(t)) = (1-lr)*dQdde(a(t),s(t)) + (er-Q(a(t),s(t)))*(rho * sess(t) * lr)*(1-lr);
		dVdde(     s(t)) = (1-lr)*dVdde(     s(t)) + (er-V(     s(t)))*(rho * sess(t) * lr)*(1-lr);
