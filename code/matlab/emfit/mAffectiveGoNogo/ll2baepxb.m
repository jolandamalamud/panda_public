function [l,dl,dsurr] = ll2baepxb(x,D,mu,nui,doprior,options);
% 
...
% noise, constant bias, separate reward and loss sensitivities, and positive
% Pavlovian bias parameter. 
% 
...
alfa 		= 1./(1+exp(-x(3)));		% learning ratenumIntervals
