function [l,dl,dsurr] = ll2b2a2epxbsepQV(x,D,mu,nui,doprior,options);
% 
% [l,dl,surrugatedata] = ll2b2a2epxbsepQV(x,D,mu,nui,doprior,options);
% 
...
% in Value and Q-value learning, andpositively constrained Pavlovian bias parameters for rewards and losses. 
% 
