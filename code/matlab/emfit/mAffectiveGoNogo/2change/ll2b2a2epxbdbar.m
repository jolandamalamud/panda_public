function [l,dl,dsurr] = ll2b2a2epxbdbar(x,D,mu,nui,doprior,options);
% 
...
for t=1:length(a)
	...
	if dodiff
		...
		dQdd(a(t),s(t)) = (1-lr)*dQdd(a(t),s(t)) + (er-Q(a(t),s(t)))*(rho * sess(t) * lr)*(1-lr);
		dVdd(     s(t)) = (1-lr)*dVdd(     s(t)) + (er-V(     s(t)))*(rho * sess(t) * lr)*(1-lr);
