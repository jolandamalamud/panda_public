function [l,dl,dsurr] = ll2b2a2epxbdbbl(x,D,mu,nui,doprior,options);
% 
...
for t=1:length(a)
    ...
    if ismember(t, rep)
       [Q, V, dQdb, dVdb, dQde, dVde, dQdd, dVdd] = init_Qvalue();
    end
	...
	if dodiff
        ...
        dQdb(a(t),s(t)) = (1-alfa(2-rho))*dQdb(a(t),s(t)) + alfa(2-rho) * psi * r(t);
		dVdb(     s(t)) = (1-alfa(2-rho))*dVdb(     s(t)) + alfa(2-rho) * psi * r(t);
        
        tmp = (dQdd(:,s(t)) + [epsilon(2-rho)*dVdd(s(t));0]);
        dl(10) = dl(10) + g*(p0(a(t)) * (tmp(a(t)) - p0'*tmp)) / pg(a(t));
        dQdd(a(t),s(t)) = (1-alfa(2-rho))*dQdd(a(t),s(t)) + alfa(2-rho) * (1-rho) * sess(t) * psi * r(t);
		dVdd(     s(t)) = (1-alfa(2-rho))*dVdd(     s(t)) + alfa(2-rho) * (1-rho) * sess(t) * psi * r(t);
        ...
        dl(9) = dl(9) + sess(t) * g*(p0(a(t)) * (tmp(a(t)) - p0'*tmp)) / pg(a(t));
