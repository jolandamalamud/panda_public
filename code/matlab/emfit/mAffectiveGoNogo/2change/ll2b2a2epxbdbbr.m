function [l,dl,dsurr] = ll2b2a2epxbdbbr(x,D,mu,nui,doprior,options);
% 
...
for t=1:length(a)
    ...
    psi = exp(beta(2-rho) + rho * sess(t) * deltabr);
	er = psi * r(t);
	...
	if dodiff
        ...
        dQdd(a(t),s(t)) = (1-alfa(2-rho))*dQdd(a(t),s(t)) + alfa(2-rho) * rho * sess(t) * psi * r(t);
		dVdd(     s(t)) = (1-alfa(2-rho))*dVdd(     s(t)) + alfa(2-rho) * rho * sess(t) * psi * r(t);
