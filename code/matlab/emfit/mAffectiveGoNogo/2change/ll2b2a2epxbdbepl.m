function [l,dl,dsurr] = ll2b2a2epxbdbepl(x,D,mu,nui,doprior,options);
% 
...
for t=1:length(a)
	...
	if dodiff
		...
		dl(6-rho) = dl(6-rho) + g*(p0(a(t))*pav*V(s(t)) * ((a(t)==1)-p0(1))) / pg(a(t));
        ...
        dl(10) = dl(10) + g*(p0(a(t)) * (1-rho) * sess(t) * pav * V(s(t)) * ((a(t)==1)-p0(1))) / pg(a(t));
