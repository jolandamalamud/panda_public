function [l,dl,dsurr] = ll2b2a2epxb20(x,D,mu,nui,doprior,options);
% 
...
for t=1:length(a)
	...
	if dodiff
		...
		tmp = (dQde(:,s(t)) + [epsilon(2-rat)*dVde(s(t));0]);
		...
		dl(6-rho) = dl(6-rho) + g*(p0(a(t))*epsilon(2-rat)*V(s(t)) * ((a(t)==1)-p0(1))) / pg(a(t));
