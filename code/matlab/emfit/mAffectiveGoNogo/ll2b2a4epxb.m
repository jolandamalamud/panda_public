function [l,dl,dsurr] = ll2b2a4epxb(x,D,mu,nui,doprior,options);
% 
...
epsilon 	= exp(x(5:8));				% 'pavlovian' parameter. Weigth of Vcue into Qgo
...
for t=1:length(a)
	...
	if dodiff
		...
		dl(s(t)+4) = dl(s(t)+4) + g*(p0(a(t))*epsilon(s(t))*V(s(t)) * ((a(t)==1)-p0(1))) / pg(a(t));
