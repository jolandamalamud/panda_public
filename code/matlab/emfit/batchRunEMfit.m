...
validvarargins = {'modelsToFit','checkgradients','maxit','bsub', 'regressor','nograd'};
if exist('varargin')
...
if exist('regressor')
	options.reg = regressor; 								% limit EM iterations
end
if exist('nograd')
	options.nograd = nograd; 								% limit EM iterations
end
